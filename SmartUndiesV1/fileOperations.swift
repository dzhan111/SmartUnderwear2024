...
func writeStringToFile(_ text: String, filePath: String) {
    do {
...
func asciiCodeToInteger(_ asciiCode: UInt8) -> Int? {
    let scalar = Unicode.Scalar(asciiCode)
    let integerValue = Int(scalar.value )
    return integerValue
}
